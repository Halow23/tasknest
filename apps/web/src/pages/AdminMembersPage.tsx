...
export default function AdminMembersPage() {
  ...
  if (loading) {
    return <main className="flex min-h-screen items-center justify-center bg-[#F7FAFB] text-sm font-bold text-[#5F7E91]">Opening member management…</main>;
  }
