...
export function BoardView({ tasks, assigneeMap, labelMap, focusedTaskId, moveTask, reorderTask, projectId, onFocusTask, onOpenTask, onNewTask }: {
  tasks: TaskSummary[];
