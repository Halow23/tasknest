...
export function TaskCard({ task, members, focused, onFocus, onOpen, onDragStart }: { task: TaskSummary; members: Member[]; focused: boolean; onFocus: () => void; onOpen: () => void; onDragStart: (event: DragEvent<HTMLButtonElement>) => void }) {
